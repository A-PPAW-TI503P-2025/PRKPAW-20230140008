...
exports.login = async (req, res) => {
  try {
    ...
    // --- PERBAIKAN DI SINI ---
    // Kita memasukkan 'email' dan memastikan 'nama' terbawa di token
    const payload = {
      id: user.id,
      nama: user.nama,  // Mengambil kolom 'nama' dari database
      email: user.email, // Menambahkan email agar muncul di Dashboard
      role: user.role 
    };
